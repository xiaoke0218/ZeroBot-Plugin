...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/ymgal"            // 月幕galgame1
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "小可", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	sus = append(sus, 965615024)
	sus = append(sus, 752269782)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "ATRI", "atri", "小可", "アトリ"),
